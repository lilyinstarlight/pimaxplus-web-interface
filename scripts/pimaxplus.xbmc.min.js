...
$("#movie-cast").after('<li><img src="'+i+'" alt="Actor" />'+t.result.moviedetails.cast[e].name+'<br /><span class="smallfont">'+t.result.moviedetails.cast[e].role+"</span></li>")}$("#movie-crew").after(pwiUtils.split(t.result.moviedetails.director)),$("#movie-info").after("<li>Released in "+t.result.moviedetails.year+"</li>"),$("#movie-info").after("<li>Duration: "+t.result.moviedetails.runtime+" minutes</li>"),$("#movie-actions").after('<li><a data-role="button" href="javascript:pwiMovies.playMovie();">Play movie</a></li>'),$("#movie-details").listview("refresh"),$("[data-role=button]").button()},this),dataType:"json"})},playMovie:function(){var t=localStorage.getItem("movie-id")
